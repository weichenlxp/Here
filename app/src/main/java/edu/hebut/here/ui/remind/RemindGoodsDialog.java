...
public class RemindGoodsDialog {
    public TextView delete;
    Context context;
    Activity activity;
    RemindGoodsAdapter remindGoodsAdapter;
    ...
    String overtime;
    String remark;
    private RemindGoodsAdapter.MyViewHolder holder;

    public void showBottomSheetDialog(Context mContext, Activity activity, int goodsID, RemindGoodsAdapter remindGoodsAdapter, RemindGoodsAdapter.MyViewHolder holder, int position) {
        this.context = mContext;
        this.activity = activity;
        this.remindGoodsAdapter = remindGoodsAdapter;
        this.holder = holder;
        ...
        Cursor goodsCursor = queryGoods(mContext, new String[]{"goodsName", "roomID", "furnitureID", "categoryID", "containerID", "goodsNum", "goodsPhoto1", "goodsPhoto2", "goodsPhoto3", "buyTime", "manufactureDate", "qualityGuaranteePeriod", "qualityGuaranteePeriodType", "packed", "remark", "overtime"}, "goodsID=?", new String[]{String.valueOf(goodsID)});
        ...
        addGoodsOvertime = view.findViewById(R.id.add_goods_overtime);
        ...
        overtime = goodsCursor.getString(15);
        ...
        addGoodsOvertime.setText(overtime);
        ...
        delete.setOnClickListener(v -> {
            remindGoodsAdapter.delete(holder, position);
            dialog.dismiss();
        });
