...
public class PackGoodsDialog {
    public TextView delete;
    Context context;
    Activity activity;
    PackGoodsAdapter packGoodsAdapter;
    ...
    String overtime;
    String remark;
    private PackGoodsAdapter.MyViewHolder holder;

    public void showBottomSheetDialog(Context mContext, Activity activity, int goodsID, PackGoodsAdapter packGoodsAdapter, PackGoodsAdapter.MyViewHolder holder, int position) {
        this.context = mContext;
        this.activity = activity;
        this.packGoodsAdapter = packGoodsAdapter;
        this.holder = holder;
...
//"manufactureDate", "qualityGuaranteePeriod", "qualityGuaranteePeriodType", "packed", "remark"
        ...
        delete.setOnClickListener(v -> {
            packGoodsAdapter.delete(holder, position);
            dialog.dismiss();
        });
