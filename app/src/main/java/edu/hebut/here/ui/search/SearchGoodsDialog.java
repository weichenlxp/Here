...
public class SearchGoodsDialog {
    ...
    String overtime;
    String remark;
    private SearchGoodsAdapter.MyViewHolder holder;

    public void showBottomSheetDialog(Context mContext, SearchActivity activity, int goodsID, SearchGoodsAdapter searchGoodsAdapter, SearchGoodsAdapter.MyViewHolder holder, int position) {
...
//"manufactureDate", "qualityGuaranteePeriod", "qualityGuaranteePeriodType", "packed", "remark"
        ...
        delete.setOnClickListener(v -> {
            searchGoodsAdapter.delete(holder, position);
            dialog.dismiss();
        });
